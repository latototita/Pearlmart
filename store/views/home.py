...
def store(request):
    ...
    context={'store':'store','productes':productes,'product_list':product_list,'page_number':page_number,'k':k,'brands':brands,'categories':categories,'brands':brands}
...
def search(request):
    ...
    if request.method=="POST":
        ...
        try:
            ...
            product_list={}
        context={'store':'store','productes':productes,'product_list':product_list,'searched':searched,'page_number':page_number,'brands':brands,'categories':categories}
